...
execute if entity @s[tag=buyer] run give @s minecraft:birch_log 64
execute if entity @s[tag=buyer] run scoreboard players operation birch_log stock -= quantity shopvars
