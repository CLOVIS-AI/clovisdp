...
function clovis:shop/oak_log/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:oak_log 64
execute if entity @s[tag=buyer] run scoreboard players operation oak_log stock -= quantity shopvars
