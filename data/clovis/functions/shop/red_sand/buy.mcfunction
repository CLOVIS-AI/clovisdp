...
function clovis:shop/red_sand/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:red_sand 64
execute if entity @s[tag=buyer] run scoreboard players operation red_sand stock -= quantity shopvars
