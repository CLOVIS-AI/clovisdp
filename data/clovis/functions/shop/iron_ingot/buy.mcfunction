...
function clovis:shop/iron_ingot/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:iron_ingot 64
execute if entity @s[tag=buyer] run scoreboard players operation iron_ingot stock -= quantity shopvars
