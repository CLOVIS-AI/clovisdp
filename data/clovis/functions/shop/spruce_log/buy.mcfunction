...
function clovis:shop/spruce_log/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:spruce_log 64
execute if entity @s[tag=buyer] run scoreboard players operation spruce_log stock -= quantity shopvars
