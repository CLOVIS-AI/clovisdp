...
function clovis:shop/granite/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:granite 64
execute if entity @s[tag=buyer] run scoreboard players operation granite stock -= quantity shopvars
