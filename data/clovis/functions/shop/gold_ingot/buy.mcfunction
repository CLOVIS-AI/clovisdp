...
execute if entity @s[tag=buyer] run give @s minecraft:gold_ingot 64
execute if entity @s[tag=buyer] run scoreboard players operation gold_ingot stock -= quantity shopvars
