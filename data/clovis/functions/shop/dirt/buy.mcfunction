...
function clovis:shop/dirt/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:dirt 64
execute if entity @s[tag=buyer] run scoreboard players operation dirt stock -= quantity shopvars
