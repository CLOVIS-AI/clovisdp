...
function clovis:shop/andesite/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:andesite 64
execute if entity @s[tag=buyer] run scoreboard players operation andesite stock -= quantity shopvars
