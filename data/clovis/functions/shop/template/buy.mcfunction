...
scoreboard players set quantity shopvars QUANTITY_BUY
...
execute if entity @s[tag=buyer] run give @s minecraft:ITEM_ID QUANTITY_BUY
execute if entity @s[tag=buyer] run scoreboard players operation ITEM_ID stock -= quantity shopvars
