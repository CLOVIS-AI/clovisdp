...
function clovis:shop/coal/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:coal 64
execute if entity @s[tag=buyer] run scoreboard players operation coal stock -= quantity shopvars
