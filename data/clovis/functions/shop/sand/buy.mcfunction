...
function clovis:shop/sand/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:sand 64
execute if entity @s[tag=buyer] run scoreboard players operation sand stock -= quantity shopvars
