...
function clovis:shop/jungle_log/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:jungle_log 64
execute if entity @s[tag=buyer] run scoreboard players operation jungle_log stock -= quantity shopvars
