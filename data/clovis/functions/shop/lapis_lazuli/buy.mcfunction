...
function clovis:shop/lapis_lazuli/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:lapis_lazuli 64
execute if entity @s[tag=buyer] run scoreboard players operation lapis_lazuli stock -= quantity shopvars
