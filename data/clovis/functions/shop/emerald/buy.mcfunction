...
scoreboard players set quantity shopvars 16
...
execute if entity @s[tag=buyer] run give @s minecraft:emerald 16
execute if entity @s[tag=buyer] run scoreboard players operation emerald stock -= quantity shopvars
