...
function clovis:shop/diamond/apply
scoreboard players set quantity shopvars 8
...
execute if entity @s[tag=buyer] run give @s minecraft:diamond 8
execute if entity @s[tag=buyer] run scoreboard players operation diamond stock -= quantity shopvars
