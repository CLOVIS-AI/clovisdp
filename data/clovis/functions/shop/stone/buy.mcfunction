...
function clovis:shop/stone/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:stone 64
execute if entity @s[tag=buyer] run scoreboard players operation stone stock -= quantity shopvars
