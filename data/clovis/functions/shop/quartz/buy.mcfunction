...
function clovis:shop/quartz/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:quartz 64
execute if entity @s[tag=buyer] run scoreboard players operation quartz stock -= quantity shopvars
