...
function clovis:shop/redstone/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:redstone 64
execute if entity @s[tag=buyer] run scoreboard players operation redstone stock -= quantity shopvars
