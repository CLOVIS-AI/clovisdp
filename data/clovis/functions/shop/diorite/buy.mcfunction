...
function clovis:shop/diorite/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:diorite 64
execute if entity @s[tag=buyer] run scoreboard players operation diorite stock -= quantity shopvars
