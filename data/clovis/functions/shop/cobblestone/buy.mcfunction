...
function clovis:shop/cobblestone/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:cobblestone 64
execute if entity @s[tag=buyer] run scoreboard players operation cobblestone stock -= quantity shopvars
