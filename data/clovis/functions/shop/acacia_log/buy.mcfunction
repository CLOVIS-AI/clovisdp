...
function clovis:shop/acacia_log/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:acacia_log 64
execute if entity @s[tag=buyer] run scoreboard players operation acacia_log stock -= quantity shopvars
