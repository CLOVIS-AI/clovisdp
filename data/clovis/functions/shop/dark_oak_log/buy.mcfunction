...
function clovis:shop/dark_oak_log/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:dark_oak_log 64
execute if entity @s[tag=buyer] run scoreboard players operation dark_oak_log stock -= quantity shopvars
