...
function clovis:shop/gravel/apply
...
execute if entity @s[tag=buyer] run give @s minecraft:gravel 64
execute if entity @s[tag=buyer] run scoreboard players operation gravel stock -= quantity shopvars
